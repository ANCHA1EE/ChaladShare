...
const AISummary = () => {
  ...
  const uploadToAI = async (pdfFile) => {
    ...
    setErrorMsg("");
    setSummaryHtml("");
    // setStatusMsg("กำลังส่งไฟล์ไปที่ AI...");
    ...
    try {
      ...
      // setStatusMsg(`AI รับไฟล์แล้ว (HTTP ${res.status}) กำลังประมวลผล...`);
              ...
              <aside className="ai-source-panel">
                ...
                {!hasFile ? (
                  ...
                  <div className="ai-file">
                    ...
                    {/* <button
                    type="button"
                    className="ai-resummarize-inline"
                    onClick={(e) => {
                      e.preventDefault();
                      onResummarize();
                    }}
                ...
                {!summaryHtml && (
                  <div className="ai-greet">
                    ...
                    <div className="ai-greet-text">
                      ...
                      {/* {statusMsg && (
                        <div style={{ marginTop: 12, fontWeight: 700, color: "#0b5394" }}>
                          {statusMsg}
                        </div>
                      )} */}
